...
const serverEnvSchema = z.object({
  ...
  GOOGLE_PLACES_MAX_RESULTS_PER_RUN: z.string().optional(),
  GOOGLE_PLACES_MAX_QUERIES: z.string().optional(),
  GOOGLE_PLACES_PAGES_PER_QUERY: z.string().optional(),
  GOOGLE_PLACES_PAGE_SIZE: z.string().optional(),
  GOOGLE_PLACES_PAGE_TOKEN_DELAY_MS: z.string().optional(),
